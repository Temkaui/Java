package com.codingdojo.cable.controllers;
...
import com.codingdojo.cable.services.MyPackageService;
import com.codingdojo.cable.services.UserService;
import com.codingdojo.cable.validators.UserValidator;
...
public class Users {
	...
	private MyPackageService pService;
	
	public Users(UserService userService, UserValidator userValidator, MyPackageService pservice) {
...
//		model.addAttribute("shows", pService.findAll());
		return "index";
	}
...
//		model.addAttribute("mypackages", pService.findAll());
		return "mypackages";
...
//		model.addAttribute("show", new MyPackage());
//		return "new";
//	}
//	
//	@PostMapping("shows/create")
//	public String shows(@Valid @ModelAttribute("show") MyPackage mypackage, BindingResult result) {
//		System.out.println(mypackage.getCreator().getName());
//		System.out.println(mypackage.getShowname());
//		if(result.hasErrors()) {
//			return "new";
//		}
